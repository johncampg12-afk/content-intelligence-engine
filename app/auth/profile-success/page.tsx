  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (session) {
        ...
        router.push(`/dashboard/settings?${success ? 'success=' + success : ''}`)
        return
      }
    ...
    checkSession()
  }, [router, supabase, attempts, searchParams])
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <p className="text-gray-600">Updating profile... (attempt {attempts + 1}/3)</p>
      </div>
    </div>
  )
}